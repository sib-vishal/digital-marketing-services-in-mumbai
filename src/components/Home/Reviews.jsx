          ...
          <div className="lg:w-[50%] ">
            ...
            <div className="lg:w-[70%] grid grid-cols-2  gap-6 mt-8">
              <div className="text-center p-[20px_10px] text-white bg-[#4582FF]   rounded-2xl">
                <h1 className="text-[27px] md:text-[36px] font-redhat font-bold ">3x</h1>
                <p className="mt-[2px] max-md:text-[14px] leading-tight  ">Growth in Revenue Generated</p>
              </div>
              <div className="text-center p-[20px_10px] text-white  bg-[#f49200] rounded-2xl ">
                ...
                <p className="mt-[2px] max-md:text-[14px] leading-tight  ">Increase in Organic Leads</p>
              </div>
            </div>
          </div>
